    ...
    async def profile_info(self, interaction: discord.Interaction):
        ...
        embed = Embed(
            ...
            description=(
                ...
                "• 🏆 **Update CWS Wins** – Lets you enter your **new total Crew Wars wins**.\n"
                "• 📊 **Check Activity Status** – Shows whether you are currently marked as active or having no recent activity.\n\n"
                "**Where to find your total wins:**\n"
                "You can find your total Crew Wars wins by following the guide here:\n"
                "<https://discord.com/channels/1302588750630621184/1302588751125413962/1443972268333076531>\n\n"
                "**Useful commands:**\n"
